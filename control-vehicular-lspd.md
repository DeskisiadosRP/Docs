...
{% hint style="info" %}
**LSPD debe seguir este procedimiento antes de cachear un vehículo**
{% endhint %}
...
{% hint style="success" %}
**Siempre solicita documentos antes de cualquier acción adicional**
{% endhint %}

***

## 3️⃣ Evaluación de Comportamiento Sospechoso
...
## 4️⃣ Solicitud de Retiro de Máscara
...
## 5️⃣ Cacheo del Vehículo - Cuándo Está Permitido
...
{% hint style="success" %}
**CON causa probable, el cacheo es legal y justificado**
{% endhint %}
{% endtab %}
...
## 6️⃣ Procedimiento de Cacheo del Vehículo
...
### PASO 2: Cacheo Personal Primero

```
👮 /me procede a cachear al conductor
👮 /me palpa los bolsillos del pantalón
👮 /me revisa la cintura
👮 /do ¿Porta algún arma o droga?
[Esperar respuesta del conductor]
```

{% hint style="info" %}
**Siempre cachea a la persona ANTES de revisar el vehículo por seguridad**
{% endhint %}

***

### PASO 3: Revisar el Interior del Vehículo

```
👮 /me abre la puerta del conductor
👮 /me comienza a revisar la guantera
👮 /do ¿Qué encuentro en la guantera?
[Esperar respuesta]
```
...
👮 /me revisa cuidadosamente el contenido
👮 /me busca compartimentos ocultos
```

{% hint style="warning" %}
**Usa SIEMPRE /do para cada área que revises. No asumas hallazgos.**
{% endhint %}

***

## 7️⃣ Resultados del Cacheo
...
👮 "Tiene 72 horas para obtener su licencia. Que tenga buen día"
```
{% endtab %}
...
🚗 Conductor: /me entrega los documentos nerviosamente
...
👮 Oficial: /me palpa los bolsillos y la cintura
👮 Oficial: /do ¿Porta algo ilegal?

🚗 Conductor: /do No porta nada en el cuerpo

👮 Oficial: /me se dirige al vehículo
👮 Oficial: /me abre la puerta del conductor
👮 Oficial: /me comienza a revisar la guantera
👮 Oficial: /do ¿Qué encuentro en la guantera?

🚗 Conductor: /do Hay papeles del auto y un GPS

👮 Oficial: /me revisa debajo de los asientos
👮 Oficial: /do ¿Hay algo debajo de los asientos?

🚗 Conductor: /do No hay nada

👮 Oficial: /me se dirige al maletero
...
## ⚠️ Importante para LSPD: Reglas de Oro
...
### ❌ ERROR 1: Cachear Sin Causa

```
❌ MAL:
👮 "Buenos días, voy a revisar su auto"
[Sin ninguna razón o sospecha]

✅ BIEN:
👮 "Noto un olor extraño proveniente del vehículo"
👮 "Esto me da causa probable para revisar"
```
...
```
❌ MAL:
👮 /me abre la guantera y encuentra drogas

✅ BIEN:
👮 /me abre la guantera
👮 /do ¿Qué encuentro dentro?
[Esperar respuesta]
```

***

### ❌ ERROR 3: Robar Objetos Legales

```
❌ MAL:
👮 /me encuentra $5,000 en el auto
👮 /me se guarda el dinero [CORRUPCIÓN]

✅ BIEN:
👮 /me encuentra $5,000 en el auto
👮 "¿De dónde proviene este dinero?"
[Solo incautar SI es evidencia de delito]
```
...
* [📹 Uso y Destrucción de Bodycam](uso-y-destruccion-de-bodycam.md) - Registro de evidencia
